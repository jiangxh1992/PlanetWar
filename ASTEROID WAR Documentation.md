...
### 5.4 Characters
**[TODO: The link to the header below seems not work]**
...
Therefore, a algorithm to generate aesthetically-pleasing color randomly is on the list of further work. One possible solution is to use a golden ratio and one examples can be found at [here][color].
